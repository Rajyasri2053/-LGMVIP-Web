...
function readFormData() {
  ...
  formData["SportName"] = document.getElementById("SportName").value;
...
function insertNewRecord(data) {
  ...
  cell3.innerHTML = data.SportName;
...
function onEdit(td) {
  ...
  document.getElementById("SportName").value = selectedRow.cells[2].innerHTML;
...
function updateRecord(formData) {
  ...
  selectedRow.cells[2].innerHTML = formData.SportName;
